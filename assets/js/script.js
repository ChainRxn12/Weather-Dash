...
// create city variable and value from city search input
  ...
  // if city value is not left blank...
    if (city != '') { 
      ...
      $.ajax({
        url: "https://api.openweathermap.org/data/2.5/forecast/daily?q=" + city + "&APPID=049ec4543fbcbfe824a5ad0d764bbc6d",
        method: "GET",
        dataType: "jsonp",
        success: function(response) {
          console.log(response);
          var fiveDayList = fiveDayForecast(response);
          $("#five-day-forecast").html(fiveDayList);
        }
